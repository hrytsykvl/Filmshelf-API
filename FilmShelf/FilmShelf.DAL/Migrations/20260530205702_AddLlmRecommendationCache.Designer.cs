...
namespace FilmShelf.DAL.Migrations
{
    ...
    [Migration("20260530205702_AddLlmRecommendationCache")]
    partial class AddLlmRecommendationCache
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.HasSequence("NotificationSequence");
            ...
            modelBuilder.Entity("FilmShelf.DAL.Entities.LlmRecommendationCache", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("LlmRecommendationCaches");
                });
            ...
            modelBuilder.Entity("FilmShelf.DAL.Entities.Notification", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("FilmShelf.DAL.Entities.ReviewResponse", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FilmShelf.DAL.Entities.ReviewNotification", b =>
                {
                    b.HasBaseType("FilmShelf.DAL.Entities.Notification");
            ...
            modelBuilder.Entity("FilmShelf.DAL.Entities.ReviewResponse", b =>
                {
                    b.HasOne("FilmShelf.DAL.Entities.Review", "Review")
            ...
            modelBuilder.Entity("FilmShelf.DAL.Entities.ReviewNotification", b =>
                {
                    b.HasOne("FilmShelf.DAL.Entities.ReviewResponse", "ReviewResponse")
                        .WithMany("Notifications")
